...
var _SlotPointer = require("./SlotPointer");

var _SlotPointer2 = _interopRequireDefault(_SlotPointer);

var _DurationSelectBox = require("./DurationSelectBox");

var _DurationSelectBox2 = _interopRequireDefault(_DurationSelectBox);
...
var SchedularContent = _styledComponents2.default.div(_templateObject);

var HeaderActionButtons = _styledComponents2.default.div(_templateObject2);

var LeftButton = _styledComponents2.default.div(_templateObject3);

var RightButton = _styledComponents2.default.div(_templateObject4);
...
var Scheduler = (_temp = _class = function (_Component) {
  ...
  _createClass(Scheduler, [{
    ...
    value: function render() {
      ...
      var localeMoment = schedulerData.localeMoment,
          selectDate = schedulerData.selectDate;
      ...
      var tbodyContent = _react2.default.createElement("div", null);
      if (showAgenda) {
        tbodyContent = _react2.default.createElement(_AgendaView2.default, this.props);
      } else {
        var _schedulerContentStyl;
        ...
        var schedulerContentStyle = (_schedulerContentStyl = {
          overflow: "hidden",
          margin: "0px",
          position: "relative"
        }, _defineProperty(_schedulerContentStyl, "margin", "-30px 45px 0px"), _defineProperty(_schedulerContentStyl, "paddingBottom", contentPaddingBottom), _schedulerContentStyl);
        ...
        tbodyContent = _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        " ",
                        _react2.default.createElement(_DurationSelectBox2.default, {
          ...
          _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  { onClick: function onClick() {
                      return _this2.scrollLeftFuncion();
                    } },
                ...
                _react2.default.createElement(
                  RightButton,
                  { onClick: function onClick() {
                      return _this2.scrollRightFunction();
                    } },
                  _react2.default.createElement(_icon2.default, {
                    type: "right",
                    style: { fontSize: "12px", color: "#6E717C" }
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                "div",
                { style: { width: schedulerWidth, height: "auto" } },
                _react2.default.createElement(
                  "div",
                ...
                _react2.default.createElement(_TimeLine2.default, { maxWidth: schedulerData.getContentTableWidth() }),
                _react2.default.createElement(_SlotPointer2.default, { maxWidth: schedulerData.getContentTableWidth() })
              )
            )
          )
        );
      ...
      if (config.headerEnabled) {
        schedulerHeader = _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "div",
              { className: "header2-text calender-box" },
              _react2.default.createElement(_icon2.default, {
                type: "left",
  ...
  locations: _propTypes.PropTypes.array.isRequired,
  handleLocationChange: _propTypes.PropTypes.func.isRequired,
  currentLocation: _propTypes.PropTypes.any,
  customViewType: _propTypes.PropTypes.number.isRequired,
  ...
  this.sideScroll = function (element, direction, speed, distance, step) {
    var scrollAmount = 0;
  ...
  this.scrollLeftFuncion = function () {
    var element = document.getElementById("auto-scroll");
    _this3.sideScroll(element, "left", 25, 100, 10);
  };

  this.scrollRightFunction = function () {
    var element = document.getElementById("auto-scroll");
    _this3.sideScroll(element, "right", 25, 100, 10);
  };

  this.getLocationOptions = function (locations) {
    var options = locations.map(function (row) {
      return _react2.default.createElement(
        _antd.Select.Option,
